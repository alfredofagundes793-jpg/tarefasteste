...
function initializeDragAndDrop() {
  // Delegated event listeners para drag and drop
...
function handleDragOver(e) {
  ...
  const taskItem = e.target.closest('.task-item, .kanban-card, .calendar-task-item, .calendar-week-task-item');
  if (!taskItem || taskItem === dragState.draggedElement) return;
...
function handleDrop(e) {
  ...
  if (!targetItem || !dragState.draggedTaskId) return;
...
function handleTouchMove(e) {
  ...
  if (!targetItem || targetItem === touchState.element) return;
